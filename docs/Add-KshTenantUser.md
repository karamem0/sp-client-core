...
The `Add-KshTenantUser` cmdlet adds a new user to a site collection.
...
This example adds a new user to the site collection at the given URL with a login name, email, and title.
...
This example adds a new user to the specified site collection with a login name, email, and title.
