...
This example shows what would happen if the cmdlet runs without actually creating the column. The column would be named "Expenses" with the title "Monthly Expenses".
