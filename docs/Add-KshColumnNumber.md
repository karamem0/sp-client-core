...
## DESCRIPTION
The Add-KshColumnNumber cmdlet adds new number column to the current site or the specified list.

## EXAMPLES

### Example 1
```powershell
PS C:\> Add-KshColumnNumber -Name 'NumberColumn' -MinimumValue 0 -MaximumValue 1000
```
