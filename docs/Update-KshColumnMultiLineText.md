...
```
Update-KshColumnMultiLineText [-Identity] <Column> [-ClientSideComponentId <String>]
...
## DESCRIPTION
The Update-KshColumnMultiLineText cmdlet updates properties of the column of multi line text type.
