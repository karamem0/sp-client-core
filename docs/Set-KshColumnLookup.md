...
## DESCRIPTION
The Set-KshColumnLookup cmdlet updates properties of the column of lookup type.

## EXAMPLES

### Example 1
```powershell
PS C:\> Set-KshColumnLookup -Identity (Get-KshColumn -ColumnId '35aa78a6-66d7-472c-ab6b-d534193842af') -ReadOnly $true
```
