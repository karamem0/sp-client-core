...
```
Set-KshColumnCalculated [-Identity] <Column> [-ClientSideComponentId <String>]
 ...
 [-StaticName <String>] [-Title <String>] [-PushChanges] [-PassThru] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

## DESCRIPTION
The Set-KshColumnCalculated cmdlet updates properties of the column of calculated type.

## EXAMPLES

### Example 1
```powershell
PS C:\> Set-KshColumnCalculated -Identity (Get-KshColumn -ColumnId '35aa78a6-66d7-472c-ab6b-d534193842af') -ReadOnly $true
```
