...
### ParamSet1
```
New-KshColumnChoice [-List] <List> [-ChoiceFormat <ChoiceFormatType>] [-Choices <String[]>]
...
### ParamSet2
```
New-KshColumnChoice [-ChoiceFormat <ChoiceFormatType>] [-Choices <String[]>] [-ClientSideComponentId <String>]
...
## DESCRIPTION
The New-KshColumnChoice cmdlet adds new choice column to the current site or the specified list.
