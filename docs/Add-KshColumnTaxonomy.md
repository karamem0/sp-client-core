...
## DESCRIPTION
The Add-KshColumnTaxonomy cmdlet adds new taxonomy column to the current site or the specified list.

## EXAMPLES

### Example 1
```powershell
PS C:\> Add-KshColumnTaxonomy -Name 'TaxonomyColumn' -TermSet (Get-KshTermSet -TermGroup (Get-KshTermGroup -TermGroupName 'Company') -TermSetId '543a5c66-1de4-475a-9047-e4bd3aa4f2d7')
```
