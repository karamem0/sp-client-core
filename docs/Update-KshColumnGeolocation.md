...
```
Update-KshColumnGeolocation [-Identity] <Column> [-ClientSideComponentId <String>]
...
## DESCRIPTION
The Update-KshColumnGeolocation cmdlet updates properties of the column of geolocation type.
