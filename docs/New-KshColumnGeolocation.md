...
### ParamSet1
```
New-KshColumnGeolocation [-List] <List> [-ClientSideComponentId <String>]
...
### ParamSet2
```
New-KshColumnGeolocation [-ClientSideComponentId <String>] [-ClientSideComponentProperties <String>]
...
## DESCRIPTION
The New-KshColumnGeolocation cmdlet adds new geolocation column to the current site or the specified list.
...
### Karamem0.SharePoint.PowerShell.Models.ColumnGeolocation
