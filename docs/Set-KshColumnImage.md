...
```
Set-KshColumnImage [-Identity] <Column> [-ClientSideComponentId <String>]
...
## DESCRIPTION
The Set-KshColumnImage cmdlet updates properties of the column of image type.

## EXAMPLES

### Example 1
```powershell
PS C:\> Set-KshColumnImage -Identity (Get-KshColumn -ColumnId '35aa78a6-66d7-472c-ab6b-d534193842af') -ReadOnly $true
```
