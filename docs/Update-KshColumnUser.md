...
```
Update-KshColumnUser [-Identity] <Column> [-AllowMultipleValues] [-ClientSideComponentId <String>]
...
## DESCRIPTION
The Update-KshColumnUser cmdlet updates properties of the column of user type.
