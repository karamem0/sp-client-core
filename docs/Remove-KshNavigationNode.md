...
The `Remove-KshNavigationNode` cmdlet removes a navigation node.
...
```powershell
PS C:\> Remove-KshNavigationNode -Identity $node
```

This example removes the specified navigation node.
...
Specifies the navigation node to remove.
