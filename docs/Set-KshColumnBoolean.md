...
```
Set-KshColumnBoolean [-Identity] <Column> [-ClientSideComponentId <String>]
...
## DESCRIPTION
The Set-KshColumnBoolean cmdlet updates properties of the column of boolean type.

## EXAMPLES

### Example 1
```powershell
PS C:\> Set-KshColumnBoolean -Identity (Get-KshColumn -ColumnId '35aa78a6-66d7-472c-ab6b-d534193842af') -ReadOnly $true
```
