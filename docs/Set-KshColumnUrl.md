...
## SYNOPSIS
Updates a column of URL type.

## SYNTAX

```
Set-KshColumnUrl [-Identity] <Column> [-ClientSideComponentId <String>]
 ...
 [-ReadOnly <Boolean>] [-Required <Boolean>] [-StaticName <String>] [-PushChanges] [-Title <String>]
 [-PassThru] [<CommonParameters>]
```

## DESCRIPTION
The Set-KshColumnUrl cmdlet updates properties of the column of URL type.

## EXAMPLES

### Example 1
```powershell
PS C:\> Set-KshColumnUrl -Identity (Get-KshColumn -ColumnId '35aa78a6-66d7-472c-ab6b-d534193842af') -ReadOnly $true
```
