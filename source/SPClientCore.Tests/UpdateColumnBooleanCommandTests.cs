...
namespace Karamem0.SharePoint.PowerShell.Tests
{
    ...
    [TestClass()]
    [TestCategory("Update-KshColumnBoolean")]
    public class UpdateColumnBooleanCommandTests
    {

        [TestMethod()]
        public void UpdateListColumnBoolean()
        {
        ...
        [TestMethod()]
        public void UpdateSiteColumnBoolean()
        {
            using (var context = new PSCmdletContext())
            {
                var result1 = context.Runspace.InvokeCommand(
