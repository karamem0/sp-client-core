...
namespace Karamem0.SharePoint.PowerShell.Tests
{
    ...
    [TestClass()]
    [TestCategory("Get-KshDocumentSetAllowedContentType")]
    public class GetDocumentSetAllowedContentTypeCommandTests
    {

        [TestMethod()]
        public void GetDocumentSetAllowedContentTypes()
        {
