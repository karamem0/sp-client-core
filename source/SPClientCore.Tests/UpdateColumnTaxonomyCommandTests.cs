...
namespace Karamem0.SharePoint.PowerShell.Tests
{
    ...
    [TestClass()]
    [TestCategory("Update-KshColumnTaxonomy")]
    public class UpdateColumnTaxonomyCommandTests
    {

        [TestMethod()]
        public void UpdateListColumnTaxonomy()
        {
        ...
        [TestMethod()]
        public void UpdateSiteColumnTaxonomy()
        {
            using (var context = new PSCmdletContext())
            {
                var result1 = context.Runspace.InvokeCommand(
