...
namespace Karamem0.SharePoint.PowerShell.Tests
{
    ...
    [TestClass()]
    [TestCategory("Update-KshColumnMultiChoice")]
    public class UpdateColumnMultiChoiceCommandTests
    {

        [TestMethod()]
        public void UpdateListColumnMultiChoice()
        {
            using (var context = new PSCmdletContext())
            {
                ...
                var result4 = context.Runspace.InvokeCommand<ColumnMultiChoice>(
        ...
        [TestMethod()]
        public void UpdateSiteColumnMultiChoice()
        {
            using (var context = new PSCmdletContext())
            {
                var result1 = context.Runspace.InvokeCommand(
