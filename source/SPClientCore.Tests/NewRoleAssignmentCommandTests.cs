...
namespace Karamem0.SharePoint.PowerShell.Tests
{
    ...
    [TestClass()]
    [TestCategory("New-KshRoleAssignment")]
    public class NewRoleAssignmentCommandTests
    {

        [TestMethod()]
        public void CreateSiteRoleAssignment()
        {
        ...
        [TestMethod()]
        public void CreateListRoleAssignment()
        {
            using (var context = new PSCmdletContext())
            {
                var result1 = context.Runspace.InvokeCommand(
        ...
        [TestMethod()]
        public void CreateListItemRoleAssignment()
        {
            using (var context = new PSCmdletContext())
            {
                var result1 = context.Runspace.InvokeCommand(
