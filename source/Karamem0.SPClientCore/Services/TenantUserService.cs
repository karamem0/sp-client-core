...
namespace Karamem0.SharePoint.PowerShell.Services
{
    ...
    public interface ITenantUserService
    {
        ...
        User CreateObject(Uri siteCollectionUrl, IReadOnlyDictionary<string, object> creationInformation);
        ...
        void UpdateObject(Uri siteCollectionUrl, User userObject, bool isSiteCollectionAdmin);

        void UpdateObject(Uri siteCollectionUrl, string userName, bool isSiteCollectionAdmin);
    ...
    public class TenantUserService : ClientService<User>, ITenantUserService
    {
        ...
        public User CreateObject(Uri siteCollectionUrl, IReadOnlyDictionary<string, object> creationInformation)
        {
        ...
        public void UpdateObject(Uri siteCollectionUrl, User userObject, bool isSiteCollectionAdmin)
        {
            _ = siteCollectionUrl ?? throw new ArgumentNullException(nameof(siteCollectionUrl));
            _ = userObject ?? throw new ArgumentNullException(nameof(userObject));
            this.UpdateObject(siteCollectionUrl, userObject.LoginName, isSiteCollectionAdmin);
        }

        public void UpdateObject(Uri siteCollectionUrl, string userName, bool isSiteCollectionAdmin)
        {
            _ = siteCollectionUrl ?? throw new ArgumentNullException(nameof(siteCollectionUrl));
            _ = userName ?? throw new ArgumentNullException(nameof(userName));
            var requestPayload = new ClientRequestPayload();
