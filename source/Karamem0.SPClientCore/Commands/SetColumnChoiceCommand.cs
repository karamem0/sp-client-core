...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Set", "KshColumnChoice")]
    [Alias("Update-KshColumnChoice")]
    [OutputType(typeof(ColumnChoice))]
    public class SetColumnChoiceCommand : ClientObjectCmdlet<IColumnService>
    {

        public SetColumnChoiceCommand()
        {
        }
