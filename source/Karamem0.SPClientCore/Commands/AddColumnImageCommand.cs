...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Add", "KshColumnImage")]
    [Alias("New-KshColumnImage")]
    [OutputType(typeof(Column))]
    public class AddColumnImageCommand : ClientObjectCmdlet<IColumnService>
    {

        public AddColumnImageCommand()
        {
        }
        ...
        {
            var columnType = ColumnType.Thumbnail;
