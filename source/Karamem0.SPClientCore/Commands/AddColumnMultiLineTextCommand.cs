...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Add", "KshColumnMultiLineText")]
    [Alias("New-KshColumnMultiLineText")]
    [OutputType(typeof(ColumnMultiLineText))]
    public class AddColumnMultiLineTextCommand : ClientObjectCmdlet<IColumnService>
    {

        public AddColumnMultiLineTextCommand()
        {
        }
        ...
        {
            var columnType = ColumnType.Note;
