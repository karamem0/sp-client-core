...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Add", "KshColumnNumber")]
    [Alias("New-KshColumnNumber")]
    [OutputType(typeof(ColumnNumber))]
    public class AddColumnNumberCommand : ClientObjectCmdlet<IColumnService>
    {

        public AddColumnNumberCommand()
        {
        }
