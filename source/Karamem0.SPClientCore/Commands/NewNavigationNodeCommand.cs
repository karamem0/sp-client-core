...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    public class NewNavigationNodeCommand : ClientObjectCmdlet<INavigationNodeService>
    {
        ...
        protected override void ProcessRecordCore(ref List<object> outputs)
        {
            ...
            {
                outputs.Add(this.Service.CreateObject(this.NavigationNode, this.MyInvocation.BoundParameters));
            }
            if (this.ParameterSetName == "ParamSet2")
            {
                outputs.Add(this.Service.CreateObjectToQuickLaunch(this.MyInvocation.BoundParameters));
            }
            if (this.ParameterSetName == "ParamSet3")
            {
                outputs.Add(this.Service.CreateObjectToTopNavigationBar(this.MyInvocation.BoundParameters));
            }
        }
