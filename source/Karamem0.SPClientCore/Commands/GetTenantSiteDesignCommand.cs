...
[Cmdlet(VerbsCommon.Get, "KshTenantSiteDesign")]
[OutputType(typeof(TenantSiteDesign))]
public class GetTenantSiteDesignCommand : ClientObjectCmdlet<ITenantSiteDesignService>
{

    public GetTenantSiteDesignCommand()
    {
    }
