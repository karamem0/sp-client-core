...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Set", "KshColumnDateTime")]
    [Alias("Update-KshColumnDateTime")]
    [OutputType(typeof(ColumnDateTime))]
    public class SetColumnDateTimeCommand : ClientObjectCmdlet<IColumnService>
    {

        public SetColumnDateTimeCommand()
        {
        }
