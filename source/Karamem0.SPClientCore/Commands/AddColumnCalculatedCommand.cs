...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Add", "KshColumnCalculated")]
    [Alias("New-KshColumnCalculated")]
    [OutputType(typeof(ColumnCalculated))]
    public class AddColumnCalculatedCommand : ClientObjectCmdlet<IColumnService>
    {

        public AddColumnCalculatedCommand()
        {
        }
