...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Set", "KshColumnGeolocation")]
    [Alias("Update-KshColumnGeolocation")]
    [OutputType(typeof(ColumnGeolocation))]
    public class SetColumnGeolocationCommand : ClientObjectCmdlet<IColumnService>
    {

        public SetColumnGeolocationCommand()
        {
        }
