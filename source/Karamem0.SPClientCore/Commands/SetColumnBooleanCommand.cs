...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Set", "KshColumnBoolean")]
    [Alias("Update-KshColumnBoolean")]
    [OutputType(typeof(Column))]
    public class SetColumnBooleanCommand : ClientObjectCmdlet<IColumnService>
    {

        public SetColumnBooleanCommand()
        {
        }
