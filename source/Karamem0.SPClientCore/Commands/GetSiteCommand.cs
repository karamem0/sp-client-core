...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    public class GetSiteCommand : ClientObjectCmdlet<ISiteService>
    {
        ...
        protected override void ProcessRecordCore(ref List<object> outputs)
        {
            ...
            {
                outputs.Add(this.Service.GetObject(this.SiteCollection));
            }
            ...
            {
                outputs.Add(this.Service.GetObject(this.SiteId));
            }
            if (this.ParameterSetName == "ParamSet5")
            {
                if (this.SiteUrl.IsAbsoluteUri)
                {
                    outputs.Add(this.Service.GetObject(new Uri(this.SiteUrl.AbsolutePath, UriKind.Relative)));
                }
                else
                {
                    outputs.Add(this.Service.GetObject(this.SiteUrl));
                }
            }
