...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Add", "KshColumnLookup")]
    [Alias("New-KshColumnLookup")]
    [OutputType(typeof(ColumnLookup))]
    public class AddColumnLookupCommand : ClientObjectCmdlet<IColumnService>
    {

        public AddColumnLookupCommand()
        {
        }
        ...
        {
            var columnType = ColumnType.Lookup;
