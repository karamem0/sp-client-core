...
[Cmdlet(VerbsCommon.Add, "KshColumnLocation")]
[OutputType(typeof(ColumnLocation))]
public class AddColumnLocationCommand : ClientObjectCmdlet<IColumnService>
{
    ...
    {
        var columnType = ColumnType.Location;
