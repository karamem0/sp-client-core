    ...
    public class NewRoleAssignmentCommand : ClientObjectCmdlet<ISiteService, IRoleAssignmentService>
    {
        ...
        protected override void ProcessRecordCore(ref List<object> outputs)
        {
            if (this.ParameterSetName == "ParamSet1")
            {
                ...
                outputs.Add(this.Service2.CreateObject(this.Service1.GetObject(), this.Principal, this.RoleDefinition));
            }
            if (this.ParameterSetName == "ParamSet2")
            {
                outputs.Add(this.Service2.CreateObject(this.List, this.Principal, this.RoleDefinition));
            }
            if (this.ParameterSetName == "ParamSet3")
            {
                outputs.Add(this.Service2.CreateObject(this.ListItem, this.Principal, this.RoleDefinition));
            }
        }
