...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Set", "KshColumnTaxonomy")]
    [Alias("Update-KshColumnTaxonomy")]
    [OutputType(typeof(ColumnTaxonomy))]
    public class SetColumnTaxonomyCommand : ClientObjectCmdlet<IColumnService>
    {

        public SetColumnTaxonomyCommand()
        {
        }
