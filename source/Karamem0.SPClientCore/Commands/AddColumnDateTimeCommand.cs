...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Add", "KshColumnDateTime")]
    [Alias("New-KshColumnDateTime")]
    [OutputType(typeof(ColumnDateTime))]
    public class AddColumnDateTimeCommand : ClientObjectCmdlet<IColumnService>
    {

        public AddColumnDateTimeCommand()
        {
        }
