...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Add", "KshColumnGeolocation")]
    [Alias("New-KshColumnGeolocation")]
    [OutputType(typeof(ColumnGeolocation))]
    public class AddColumnGeolocationCommand : ClientObjectCmdlet<IColumnService>
    {

        public AddColumnGeolocationCommand()
        {
        }
        ...
        {
            var columnType = ColumnType.Geolocation;
