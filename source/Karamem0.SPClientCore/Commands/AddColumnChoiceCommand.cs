...
namespace Karamem0.SharePoint.PowerShell.Commands
{
    ...
    [Cmdlet("Add", "KshColumnChoice")]
    [Alias("New-KshColumnChoice")]
    [OutputType(typeof(ColumnChoice))]
    public class AddColumnChoiceCommand : ClientObjectCmdlet<IColumnService>
    {

        public AddColumnChoiceCommand()
        {
        }
        ...
        {
            var columnType = ColumnType.Choice;
