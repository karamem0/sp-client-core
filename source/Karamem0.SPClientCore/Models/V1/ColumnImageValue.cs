...
) : ODataObject
{
    ...
    public virtual string? ColumnName { get; set; } = columnName;
    ...
    public virtual string? ServerRelativeUrl { get; set; } = serverRelativeUrl;

    [JsonProperty("serverUrl")]
    public virtual string? ServerUrl { get; set; } = serverUrl;
