...
public class ColumnRatingScale : Column
{
    ...
    [JsonProperty()]
    public virtual int GridEndNumber { get; set; }

    [JsonProperty()]
    public virtual string? GridNAOptionText { get; set; }

    [JsonProperty()]
    public virtual int GridStartNumber { get; set; }

    [JsonProperty()]
    public virtual string? GridTextRangeAverage { get; set; }

    [JsonProperty()]
    public virtual string? GridTextRangeHigh { get; set; }

    [JsonProperty()]
    public virtual string? GridTextRangeLow { get; set; }
    ...
    [JsonProperty()]
    public virtual int RangeCount { get; set; }
