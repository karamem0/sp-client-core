...
public class ColumnUser : Column
{
    ...
    public virtual int SelectionGroupId { get; set; }

    [JsonProperty()]
    public virtual ColumnUserSelectionMode? SelectionMode { get; set; }
    ...
    [JsonProperty()]
    public virtual ColumnUrlFormatType? UrlFormat { get; set; }
