...
[ClientObject(Name = "SP.FieldChoice", Id = "{a0b73943-fabc-47d3-b2c8-ec41b1216b1d}")]
[JsonObject()]
public class ColumnChoice : Column
{
    ...
    public virtual ChoiceFormatType? ChoiceFormat { get; set; }
