...
public class ColumnMultiLineText : Column
{
    ...
    [JsonProperty()]
    public virtual bool AllowHyperlink { get; set; }

    [JsonProperty()]
    public virtual bool AppendOnly { get; set; }
    ...
    [JsonProperty()]
    public virtual bool RestrictedMode { get; set; }
    ...
    [JsonProperty()]
    public virtual bool WikiLinking { get; set; }
