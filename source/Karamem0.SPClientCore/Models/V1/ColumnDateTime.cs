...
[ClientObject(Name = "SP.FieldDateTime", Id = "{4f9dc9b4-d900-40eb-94b9-008abbfb22e1}")]
[JsonObject()]
public class ColumnDateTime : Column
{
    ...
    public virtual ColumnDateTimeFormatType? DateFormat { get; set; }
    ...
    public virtual ColumnDateTimeFriendlyFormatType? FriendlyFormat { get; set; }
