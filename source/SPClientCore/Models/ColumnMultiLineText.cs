...
namespace Karamem0.SharePoint.PowerShell.Models
{
    ...
    [ClientObject(Name = "SP.FieldMultiLineText", Id = "{9ae17ecc-11a6-4433-8b51-7ecb865ffe05}")]
    [JsonObject()]
    public class ColumnMultiLineText : Column
    {
        ...
        [JsonProperty()]
        public virtual bool AppendOnly { get; protected set; }
        ...
        [JsonProperty()]
        public virtual bool RestrictedMode { get; protected set; }

        [JsonProperty()]
        public virtual bool RichText { get; protected set; }
        ...
        [JsonProperty()]
        public virtual bool WikiLinking { get; protected set; }
