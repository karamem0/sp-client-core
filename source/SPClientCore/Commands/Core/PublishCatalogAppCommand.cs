...
namespace Karamem0.SharePoint.PowerShell.Commands.Core
{
    ...
    [Cmdlet("Publish", "SPCatalogApp")]
    [OutputType(typeof(CatalogApp))]
    public class PublishCatalogAppCommand : PSCmdlet
    {

        public PublishCatalogAppCommand()
        {
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                catalogAppService.DeployTenantCatalogApp(this.CatalogApp);
                if (this.PassThru)
                {
            ...
            {
                catalogAppService.DeploySiteCatalogApp(this.CatalogApp);
                if (this.PassThru)
                {
