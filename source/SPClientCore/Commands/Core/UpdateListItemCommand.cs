...
namespace Karamem0.SharePoint.PowerShell.Commands.Core
{
    ...
    [Cmdlet("Update", "SPListItem")]
    [OutputType(typeof(ListItem))]
    public class UpdateListItemCommand : ClientObjectCmdlet
    {
        ...
        public Dictionary<string, object> FieldValue { get; private set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            listItemService.UpdateListItem(list.Id, listItem.Id, this.FieldValue);
            if (this.PassThru)
            {
                this.WriteObject(listItemService.GetListItem(list.Id, new ListItemPipeBind(listItem.Id), listItemQuery));
            }
        }
