...
namespace Karamem0.SharePoint.PowerShell.Commands.Core
{
    ...
    [Cmdlet("Uninstall", "SPCatalogApp")]
    [OutputType(typeof(CatalogApp))]
    public class UninstallCatalogAppCommand : PSCmdlet
    {

        public UninstallCatalogAppCommand()
        {
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                catalogAppService.UninstallTenantCatalogApp(this.CatalogApp);
                if (this.PassThru)
                {
            ...
            {
                catalogAppService.UninstallSiteCatalogApp(this.CatalogApp);
                if (this.PassThru)
                {
