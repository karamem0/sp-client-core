...
namespace Karamem0.SharePoint.PowerShell.Commands.Core
{
    ...
    [Cmdlet("Unpublish", "SPCatalogApp")]
    [OutputType(typeof(CatalogApp))]
    public class UnpublishCatalogAppCommand : PSCmdlet
    {

        public UnpublishCatalogAppCommand()
        {
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                catalogAppService.RetractTenantCatalogApp(this.CatalogApp);
                if (this.PassThru)
                {
            ...
            {
                catalogAppService.RetractSiteCatalogApp(this.CatalogApp);
                if (this.PassThru)
                {
