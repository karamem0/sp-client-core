    ...
    public void InvokeCommand_SetItem_ShouldSucceed()
    {
        ...
        var result2 = context.Runspace.InvokeCommand<Site>(
            ...
            new Dictionary<string, object>()
            {
                ...
                ["CustomMasterUrl"] = $"{result1[0].ServerRelativeUrl}/_catalogs/masterpage/oslo.master",
                ...
                ["LogoAlignment"] = "Left",
                // ["MasterUrl"] = $"{result1[0].ServerRelativeUrl}/_catalogs/masterpage/oslo.master",
                ...
                ["SiteLogoUrl"] =  $"{result1[0].ServerRelativeUrl}/_layouts/15/images/siteicon.png",
                ["SyndicationEnabled"] = true,
                ["ThemedCssFolderUrl"] =  $"{result1[0].ServerRelativeUrl}/SiteAssets/theme.css",
                ["Title"] = "Test Site 9",
